    ...
    <section className="relative flex flex-col overflow-hidden bg-[#0a0f0a]" style={{ minHeight: "clamp(400px, 45vh, 600px)" }}>
      ...
      <div className="absolute inset-0">
        <Image
          ...
          priority
          quality={80}
          // ✅ MOBILE FIXED: center-right on all sizes so the machine (right side)
          // is always visible. Previously object-[5%_center] was showing left edge only.
          className="object-cover object-[65%_center] sm:object-[55%_center] lg:object-right"
          sizes="100vw"
        />
      </div>
