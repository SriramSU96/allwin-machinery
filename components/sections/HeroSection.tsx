          ...
          <div className="max-w-[700px] w-full">
            ...
            <div ref={ctaRef} className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-3 mb-6">
              ...
              <a
                ...
                className="btn flex items-center justify-center gap-2 text-sm text-white"
                style={{
              ...
              >
                {/* WhatsApp icon */}
                <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style={{ color: "#25D366" }}>
